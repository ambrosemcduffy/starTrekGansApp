...
class Discriminator(nn.Module):
    def __init__(self, imDim=3, hiddenDim=16):
        ...
        self.conv1 = nn.Conv2d(imDim, hiddenDim, (4, 4), 2, 1)
        self.conv2 = nn.Conv2d(hiddenDim, hiddenDim * 2, (4, 4), 2, 1)
        self.conv3 = nn.Conv2d(hiddenDim * 2, hiddenDim * 4, (4, 4), 2, 1)
        self.fc1 = nn.Linear(8 * 8 * (hiddenDim * 4), 1)
